...
def test_graphics():
    ...
    graphics_list = [
        ...
        dict(
            ...
            fill="red",
            stroke=None,
            path="300 40 m 350 40 l 360 40 370 50 370 60 c h",
        ),
        dict(
            type="path",
            fill="blue",
            line_width=10,
            line_join="bevel",
            path="400 40 m 450 40 l 460 40 470 50 470 60 c h",
        ),
        dict(type="ellipse", cx=50, cy=50, rx=50, ry=50, fill="blue", line_width=10),
        dict(
            type="text",
            content={".b": "hello friends, let's go to the store"},
            padding=[0, 0, 30, 40],
            fill="lightgreen",
            border_radius=20,
            x=250,
            ...
            width=200,
            line_width=20,
            paragraph_style={"list_text": "1. ", "text_align": "j"},
        ),
    ]

    pdf_graphics = create_graphics_from_dicts(graphics_list, pdf, 100, 100, 300)
