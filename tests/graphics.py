...
def test_graphics():
    pdf_graphics = create_graphics_from_dicts([
        ...
        dict(type='rect', x=200, y=400, height=100, width=200, fill='darkblue', border_radius=20, line_width=10, line_style='dotted'),
        ...
        dict(type='path', fill='blue', line_width=10, path='400 40 m 450 40 l 460 40 470 50 470 60 c h'),
    ])
    ...
    pdf.page.add('q 0.5 0 0 0.5 100 100 cm {} Q'.format(stream))
